...
titleLbl=Create("TextLabel",topbar,{Name="titleLbl", TextWrapped=true, Size=UDim2.new(0.5,0,1,0), Text="IRWAN&MASSIMO", TextSize=14, Font="GothamSemibold", 
